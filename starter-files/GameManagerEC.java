/**
 * This file is provided for you to test out your StreamlineEC program
...
public class GameManagerEC
{
    ...
    public static void main(String[] args)
    {
        ...
        if (args.length == 0) {
            ...
            StreamlineEC game = new StreamlineEC();
            game.play();   
            return;
        }
        ...
        if (!file.isDirectory()) {
            ...
            StreamlineEC game = new StreamlineEC(args[0]);
        ...
        for (int i=0; i<subfiles.length; i++) {
            ...
            StreamlineEC game = new StreamlineEC(subfile.toString());
     ...
     */
    static void solve(StreamlineEC game)
    {
